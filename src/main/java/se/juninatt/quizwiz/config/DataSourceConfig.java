...
public class DataSourceConfig {
     ...
     * The DataSource bean is configured with the information obtained from the application's properties file.
     *
     ...
     */
    @Bean
    public DataSource dataSource() throws DataAccessException, IllegalStateException, BeanCreationException {
